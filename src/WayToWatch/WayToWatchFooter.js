...
function WayToWatchFooter()
{
    ...
    return(
        ...
        <footer className="way-to-watch-footer">
            <div className="text-center" style={{marginBottom:"5em",fontSize:"0.8em",color:"rgba(131, 130, 130, 0.959)"}}>
           &nbsp; &nbsp; Netflix streaming membership and internet connection required. <br/>Netflix will be available on select devices from the following brands displayed.
            </div>

            <div className="way-to-watch-footer-link-container">
                <div   >
            ...
            <div className="way-to-watch-footer-last-link-img-container">
                ...
                <img src="	https://devices.netflix.com/images/flags/in.svg" alt="flag" style={{borderRadius:"2px"}}  width={"50px"} height={"40px"}/>
            </div>
        </footer>
        </>
    )
...
export default WayToWatchFooter;
