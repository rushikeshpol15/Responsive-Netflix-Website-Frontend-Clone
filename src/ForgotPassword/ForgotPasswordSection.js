    ...
    return(
        ...
        <section className="forgot-password-section">
            <div className="forgot-password-center-div">
                    ...
                    <a  className="I-cant-remember-a-tag text-decoration-none">I can't remember my email address or phone number.</a>
            </div>
            ...
            <div className="reCAPTCHA-box">
                ...
                {(!learnMoreViSibility)?<p className="text-secondary" style={{fontSize:"0.9em"}} >The information collected by Google reCAPTCHA is subject to the Google <a onClick={()=>{Navigate('/Privacy')}} className="text-decoration-none captcha-a-link fw-bold" style={{fontSize:"inherit"}}>Privacy Policy</a> and <a onClick={()=>{Navigate('/TermsOfUse')}} className="text-decoration-none captcha-a-link fw-bold" style={{fontSize:"inherit"}}>Terms of Service</a>, and is used for providing, maintaining, and improving the reCAPTCHA service and for general security purposes (it is not used for personalised advertising by Google).</p>
                :null}
