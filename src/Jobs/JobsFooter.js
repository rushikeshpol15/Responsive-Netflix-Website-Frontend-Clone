import "./Jobs.css";
import netflix from "../homepage/netflixSvg.svg";
...
function JobsFooter(props)
{
    ...
    return(
        ...
        <footer className="Jobs-footer ">
            ...
            <div className="Jobs-footer-container  d-flex ">

                <div className="footer-subcontainer-one  d-flex align-items-center" style={{gap:"8px"}}>
                    <img src={netflix} alt="img" className="Jobs-footer-netflix-tag"/>
                    <span className="footer-span-with-netflixSVG fw-bolder ">{props.JobsOrInvestors}</span>
                </div>

                <div className="footer-subcontainer-two  ms-auto d-flex flex-column" style={{gap:"10px"}}>

                    <div className="inner-container-one d-flex justify-content-end align-items-center me-2" style={{gap:"20px"}}>
                      <div className="div-follow"><strong>FOLLOW</strong> <span style={{color:"red"}} className="fw-bold">@wearenetflix</span></div>
                      ...
                      <FontAwesomeIcon icon={faLinkedin} style={{color: "#000000",width:"30px",height:"34px"}} className="fontAwesomeHover" />  
                      <FontAwesomeIcon icon={faPodcast} style={{color: "#030303",width:"30px",height:"34px"}} className="fontAwesomeHover" />
                    </div>
